...
The problem is to find the length of the longest subsequence 
which is present in both the strings in the form of anagrams.
...
like longest common subsequence,right?
