...
Given a number N. our task is to find the closest Palindrome number whose absolute 
difference with given number is minimum.
...
Take number as string and perform the operation to make  it a palindrome.
